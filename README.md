...
2. Up-play positive features during pitch to prospective sellers and buyers (i.e. maximising buyers/sellers’ returns) - consider a simple and user-friendly tool for prospective clients to play around with (try this at https://githubberst-project-2-streamlitapp2-856hmn.streamlit.app/)
